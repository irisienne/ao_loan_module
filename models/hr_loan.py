...
class hr_loan(osv.Model):
    ...
    _columns = {
        ...
        'employee_id': fields.many2one('py.employee', string="Employee", required=True),
        'parent_id': fields.many2one('py.employee', related= "employee_id.parent_id", string="Manager"),
        ...
        'rubrique_id': fields.many2one('py.rubrique', 'Rubrique'),
        'rest_pay':fields.function('Rest à Payer'), 
        'restraint':fields.float('Retenue'), 
        'interest_rate':fields.float('Taux Interêt'), 
        'interest_totals':fields.float('Cumuls Interêt'), 
...
class hr_loan_line(osv.Model):
    ...
    _columns = {    
        ...
        'employee_id': fields.many2one('py.employee', string="Employee"),
